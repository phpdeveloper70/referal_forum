...
<head>
  ...
  <title>Referal Forum | Add New Forum Category</title>
            ...
            <form role="form" method="post" id="form" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <img src="<?php echo base_url('uploads/deal/'.$RESULT[0]->image); ?>" width='100'>				  
                </div>
				<div class="form-group">
					<label for="exampleInputEmail1">Image</label>
					<input type="file" class="form-control" name="image" >
					<input type="hidden" name="hidden_file" value="<?php echo $RESULT[0]->image; ?>">	
                </div>
				<div class="form-group">

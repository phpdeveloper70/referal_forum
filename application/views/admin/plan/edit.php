...
<head>
  ...
  <title>Referal Forum | Edit Plan</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li><a href="<?php echo base_url('admin/plan/listing'); ?>">All Plans</a></li>
            ...
            <form role="form" method="post" id="form" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" name="amount" required placeholder="Enter amount" value="<?php echo $RESULT[0]->amount; ?>">				  
                </div>		
				<div class="form-group">
                  <label for="exampleInputEmail1">Description</label>
				  <textarea class="form-control" name="description" placeholder="Enter description" required><?php echo $RESULT[0]->description; ?></textarea>                  				  
                </div>				
                <div class="form-group">
                  <label for="exampleInputPassword1">Is Recommended</label>
                  <select class="form-control" name="recommended" required>
					<option value='1' <?php echo($RESULT[0]->recommended==1)?'selected':''; ?>>yes</option>
					<option value='0' <?php echo($RESULT[0]->recommended==0)?'selected':''; ?>>no</option>
				  </select>
                </div> 

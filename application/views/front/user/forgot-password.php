...
<title>Referal forum - forgot password</title>
...
<div class="container">
	<div class="login-heading">
		...
		<p>Enter your registerd email id to reset your password.</p>
	</div>
	...
	<div class="row">
		<div class="col-sm-offset-2 col-sm-8">
			<div class="login-area">
				...
				<form action="<?php echo base_url('user/forgot_password'); ?>" class="form-signin" method="post" id="login_form">
					<input type="email" id="inputEmail" class="form-control" name="email" required placeholder="Enter valid email" >
					<button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="forgot_password">Submit</button>
				</form><!-- /form -->
